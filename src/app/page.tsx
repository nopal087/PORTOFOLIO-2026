...
<div className="absolute -bottom-8 -left-8 bg-primary-fixed border-[5px] border-black p-4 font-display font-black text-2xl rotate-[-10deg] shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] z-20 uppercase">#LOUD_AF</div>
<img className="w-full h-full object-cover border-[6px] border-black shadow-[16px_16px_0px_0px_#ffd7f0] transition-transform hover:-translate-y-4 hover:shadow-[24px_24px_0px_0px_#ffd7f0] duration-300 relative z-0 grayscale contrast-150" alt="A portrait of a creative professional" src="/images/pasfoto.png" />
</div>
</section>
{/*  Marquee / Skills  */}
...
<div className="absolute -top-8 -left-8 bg-lime-brutal border-[5px] border-black p-3 font-display font-black text-2xl rotate-[-15deg] shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] z-10 hover:rotate-0 transition-transform">TIMELINE</div>
<h3 className="font-display text-[40px] font-black border-b-[6px] border-black pb-4 mb-8 uppercase bg-white p-2 inline-block">Experience</h3>
...
<div className="absolute left-[-32px] top-10 w-[6px] h-full bg-black z-10 hidden md:block"></div>
<div className="bg-secondary-fixed-dim text-black font-display font-black text-xl p-4 text-center rotate-[3deg] shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] uppercase border-[4px] border-black">AUG 23 - JAN 25</div>
<div className="bg-white border-[5px] border-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-2 hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] transition-all">
<h4 className="font-display font-black text-2xl uppercase bg-cyan-brutal inline-block px-2 mb-2 border-[2px] border-black">IT Support</h4>
<h5 className="font-display font-bold text-xl uppercase mb-4">@ PT Bank Rakyat Indonesia</h5>
<p className="font-body-lg text-xl font-bold bg-gray-100 p-4 border-[3px] border-black border-dashed">Menangani 120+ tiket per bulan, memelihara LAN/Wi-Fi, e-Channel (ATM, CRM), serta hardening sistem dengan tingkat SLA 98%.</p>
</div>
</div>
<div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-6 items-start relative group">
...
<div className="bg-lime-brutal text-black font-display font-black text-xl p-4 text-center rotate-[-2deg] shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] uppercase border-[4px] border-black">FEB 22 - JUN 22</div>
<div className="bg-white border-[5px] border-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-2 hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] transition-all">
<h4 className="font-display font-black text-2xl uppercase bg-white inline-block px-2 mb-2 border-[4px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">Software Engineer Intern</h4>
<h5 className="font-display font-bold text-xl uppercase mb-4">@ PT Stechoq Robotika</h5>
<p className="font-body-lg text-xl font-bold bg-gray-100 p-4 border-[3px] border-black border-dashed">Mengembangkan sistem Self-Checkout berbasis RFID secara end-to-end dengan Express.js dan mendesain UI di Figma.</p>
</div>
</div>
</div>
</div>
{/*  Education Box  */}
<div className="bg-secondary-fixed-dim border-[6px] border-black p-10 shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] lg:col-span-12 relative bg-stripes">
<div className="absolute -top-8 right-10 bg-black text-white border-[5px] border-white p-3 font-display font-black text-2xl rotate-[5deg] shadow-[6px_6px_0px_0px_#00ffff] z-10 hover:rotate-0 transition-transform uppercase">KNOWLEDGE_BASE</div>
<h3 className="font-display text-[40px] font-black border-b-[6px] border-black pb-4 mb-8 uppercase bg-white p-2 inline-block">Education</h3>
...
<div className="absolute -right-10 -bottom-10 text-[100px] text-primary-fixed opacity-30 font-black rotate-[-20deg] pointer-events-none group-hover:scale-110 transition-transform">S.KOM</div>
<div className="bg-primary-fixed border-[3px] border-black font-display font-black px-4 py-1 inline-block mb-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transform -skew-x-12">2019 - 2023</div>
<h4 className="font-display font-black text-3xl uppercase mb-2 leading-tight">S1 Teknik Informatika</h4>
...
<div className="absolute -top-8 -left-8 bg-primary-fixed border-[6px] border-black px-8 py-3 font-display font-black text-3xl rotate-[-8deg] shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] z-20 hover:rotate-0 transition-transform uppercase tracking-widest">FEATURED</div>
...
<img className="w-full h-auto object-cover transition-transform duration-700 group-hover:scale-110 group-hover:rotate-1" alt="A screenshot of WMS KAI Services website interface." src="/images/wms.png"/>
...
<span className="bg-black text-white px-4 py-2 font-display font-black text-sm uppercase border-[2px] border-black shadow-[4px_4px_0px_0px_#fde400]">Next.js</span>
<span className="bg-black text-white px-4 py-2 font-display font-black text-sm uppercase border-[2px] border-black shadow-[4px_4px_0px_0px_#fde400]">Golang</span>
<span className="bg-black text-white px-4 py-2 font-display font-black text-sm uppercase border-[2px] border-black shadow-[4px_4px_0px_0px_#fde400]">PostgreSQL</span>
</div>
<div>
<h3 className="font-display text-[30px] md:text-[40px] font-black uppercase leading-[0.85] mb-6 tracking-tighter bg-secondary-fixed-dim inline-block p-2 border-[4px] border-black transform -skew-x-6">Warehouse Management System <br/>KAI Services</h3>
<p className="font-body-lg text-lg font-bold text-on-surface bg-gray-100 p-4 border-[4px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">Warehouse Management System (WMS) kelas Enterprise yang dirancang khusus untuk operasional Gudang PT Reska Multi Usaha (KAI Services) Regional Office 04 Semarang. Sistem ini menggunakan arsitektur modern Next.js di frontend dan Go (Golang) + PostgreSQL di backend.</p>
</div>
...
<span className="block font-display font-black text-sm uppercase border-b-2 border-black pb-1 mb-1">Role</span>
<span className="font-body-lg font-bold text-lg leading-tight uppercase">Full Stack Dev</span>
</div>
<div className="bg-lime-brutal p-3 border-[3px] border-black">
<span className="block font-display font-black text-sm uppercase border-b-2 border-black pb-1 mb-1">Status</span>
<span className="font-body-lg font-bold text-lg leading-tight uppercase">Enterprise</span>
</div>
</div>
<button className="mt-6 border-[6px] border-black bg-primary-fixed py-6 px-8 font-display font-black text-2xl hover:bg-black hover:text-primary-fixed transition-colors shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] active:translate-y-2 active:shadow-none uppercase tracking-widest group">
                        LAUNCH PROJECT <span className="material-symbols-outlined ml-2 group-hover:translate-x-2 transition-transform">arrow_forward</span>
</button>
</div>
</div>
...
<span className="material-symbols-outlined text-4xl text-black">article</span>
</div>
...
<img className="w-full h-full object-contain bg-white border-[2px] border-black transition-transform duration-700 group-hover:scale-110 grayscale group-hover:grayscale-0" alt="Loko Cafe System Management" src="/images/lsm.png"/>
</div>
<div className="flex flex-col gap-6 bg-white p-6 border-[5px] border-black flex-grow shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
<div className="flex gap-3">
<span className="border-[3px] border-black px-3 py-1 font-display font-black text-xs uppercase bg-primary-fixed shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">Next.js</span>
<span className="border-[3px] border-black px-3 py-1 font-display font-black text-xs uppercase bg-cyan-brutal shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">Supabase</span>
</div>
<h3 className="font-display text-[26px] xl:text-[32px] uppercase font-black leading-none bg-black text-white inline-block p-2 transform -skew-x-6">LOKO CAFE<br/>SYSTEM MANAGEMENT</h3>
<p className="font-body-lg font-bold text-sm xl:text-base text-on-surface border-l-[6px] border-primary-fixed pl-4">LOKO KAFE APPS adalah platform manajemen operasional yang terintegrasi dengan Warehouse Management System (WMS) terintegrasi untuk jajaran outlet Loko Kafe (termasuk Semarang Tawang dan Semarang Poncol). Sistem ini dirancang untuk menghubungkan seluruh rantai operasional kafe: dari manajemen persediaan bahan baku, resep produk, penerimaan/pengeluaran barang, audit stock opname, cetak label stiker inventaris dengan AI background removal, penarikan data transaksi POS Trainmart (Reska), penilaian kinerja crew, hingga komunikasi internal tim secara real-time.</p>
...
<span className="material-symbols-outlined text-4xl text-black">code</span>
</div>
<div className="aspect-video border-[6px] border-black w-full overflow-hidden relative shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] bg-white p-2">
...
<img className="w-full h-full object-contain bg-white border-[2px] border-black transition-transform duration-700 group-hover:scale-110 grayscale group-hover:grayscale-0" alt="This Web Portofolio interface" src="/images/portofolio.png"/>
</div>
<div className="flex flex-col gap-6 bg-white p-6 border-[5px] border-black flex-grow shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
<div className="flex gap-3">
<span className="border-[3px] border-black px-3 py-1 font-display font-black text-xs uppercase bg-secondary-fixed-dim shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">Next.js</span>
<span className="border-[3px] border-black px-3 py-1 font-display font-black text-xs uppercase bg-primary-fixed shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">Tailwind v4</span>
</div>
<h3 className="font-display text-[32px] md:text-[36px] uppercase font-black leading-none bg-black text-white inline-block p-2 transform -skew-x-6">THIS WEB<br/>PORTOFOLIO</h3>
<p className="font-body-lg font-bold text-sm xl:text-base text-on-surface border-l-[6px] border-cyan-brutal pl-4">Portofolio pribadi yang dirancang menggunakan gaya desain Neobrutalism yang berani, mencolok, dan highly-functional. Dibangun dari nol menggunakan Next.js App Router, Tailwind CSS v4, dan dikembangkan secara interaktif dengan bantuan teknologi Agentic AI terkini.</p>
...
<div className="absolute -top-6 -right-6 bg-white border-[5px] border-black p-4 rounded-full z-20 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] group-hover:rotate-180 transition-transform duration-700">
<span className="material-symbols-outlined text-4xl text-black">gavel</span>
</div>
<div className="aspect-video border-[6px] border-black w-full overflow-hidden relative shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] bg-white p-2">
...
<img className="w-full h-full object-contain bg-white border-[2px] border-black transition-transform duration-700 group-hover:scale-110 grayscale group-hover:grayscale-0" alt="IRIS System Interface" src="/images/iris.png"/>
</div>
<div className="flex flex-col gap-6 bg-white p-6 border-[5px] border-black flex-grow shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
<div className="flex gap-3">
<span className="border-[3px] border-black px-3 py-1 font-display font-black text-xs uppercase bg-secondary-fixed-dim shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">Next.js</span>
<span className="border-[3px] border-black px-3 py-1 font-display font-black text-xs uppercase bg-cyan-brutal shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">Firebase</span>
</div>
<h3 className="font-display text-[32px] md:text-[36px] uppercase font-black leading-none bg-black text-white inline-block p-2 transform -skew-x-6">IRIS<br/>SYSTEM</h3>
<p className="font-body-lg font-bold text-sm xl:text-base text-on-surface border-l-[6px] border-lime-brutal pl-4">IRIS (Industrial Relations Information System) adalah platform manajemen hubungan industrial terpadu yang dirancang untuk memudahkan pendataan. Sistem ini mendigitalisasi seluruh proses penanganan kasus karyawan, mulai dari pembinaan (SP1-SP3) hingga penanganan pelanggaran berat (PHK Mendesak) secara objektif, transparan, dan terukur.</p>
...
{/*  Instagram  */}
<a className="bg-black text-white border-[6px] border-black p-8 flex flex-col items-center justify-center gap-6 hover:bg-primary-fixed hover:text-black transition-colors shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-2 group rotate-[2deg] hover:rotate-0" href="https://www.instagram.com/nopal_087/" target="_blank" rel="noopener noreferrer">
<span className="material-symbols-outlined text-[80px] group-hover:scale-110 transition-transform">photo_camera</span>
<span className="font-display font-black text-2xl lg:text-3xl uppercase tracking-widest bg-white text-black px-4 py-1 border-[4px] border-black">INSTAGRAM</span>
</a>
{/*  GitHub  */}
<a className="bg-black text-white border-[6px] border-black p-8 flex flex-col items-center justify-center gap-6 hover:bg-cyan-brutal hover:text-black transition-colors shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-2 group rotate-[-3deg] hover:rotate-0" href="https://github.com/nopal087/" target="_blank" rel="noopener noreferrer">
<span className="material-symbols-outlined text-[80px] group-hover:scale-110 transition-transform">code</span>
<span className="font-display font-black text-2xl lg:text-3xl uppercase tracking-widest bg-white text-black px-4 py-1 border-[4px] border-black">GITHUB</span>
</a>
{/*  LinkedIn  */}
<a className="bg-black text-white border-[6px] border-black p-8 flex flex-col items-center justify-center gap-6 hover:bg-secondary-fixed-dim hover:text-black transition-colors shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-2 group rotate-[4deg] hover:rotate-0" href="https://www.linkedin.com/in/muhammadnaufalfaruq/" target="_blank" rel="noopener noreferrer">
<span className="material-symbols-outlined text-[80px] group-hover:scale-110 transition-transform">work</span>
<span className="font-display font-black text-2xl lg:text-3xl uppercase tracking-widest bg-white text-black px-4 py-1 border-[4px] border-black">LINKEDIN</span>
</a>
{/*  Email  */}
<a className="bg-black text-white border-[6px] border-black p-8 flex flex-col items-center justify-center gap-6 hover:bg-lime-brutal hover:text-black transition-colors shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-2 group rotate-[-1deg] hover:rotate-0" href="mailto:naufalfaruq285@gmail.com">
<span className="material-symbols-outlined text-[80px] group-hover:scale-110 transition-transform">mail</span>
<span className="font-display font-black text-2xl lg:text-3xl uppercase tracking-widest bg-white text-black px-4 py-1 border-[4px] border-black">EMAIL</span>
</a>
</div>
</section>
{/*  Testimonials  */}
...
<p className="font-body-lg text-2xl font-bold max-w-sm border-l-[6px] border-lime-brutal pl-6 uppercase text-gray-300">Designing for the brutal web. No fluff, just structure and impact.</p>
</div>
